...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pw-toggle { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: none; border: none; color: var(--faint); cursor: pointer; padding: 2px; font-size: 15px; transition: color .2s; }
    ...
    <div class="scene">
        ...
        <div class="panel-right">
            ...
            <div class="form-heading">
                Konfirmasi <span>Kata Sandi</span>
            </div>
            <div class="form-sub">
                Ini adalah area aman. Harap konfirmasi kata sandi Anda sebelum melanjutkan ke halaman yang diminta.
            </div>
