<x-app-layout>
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-2">
                            <li class="flex items-center">
                                <a href="{{ route('dashboard') }}" class="text-[10px] font-black text-slate-400 hover:text-blue-600 transition-colors uppercase tracking-[0.2em]">Dashboard</a>
                            </li>
                            <li class="flex items-center">
                                <i class="bi bi-chevron-right text-[10px] text-slate-300 mx-1"></i>
                                <span class="text-[10px] font-black text-slate-600 uppercase tracking-[0.2em]">Pengaturan Profil</span>
                            </li>
                        </ol>
                    </nav>
                    <h1 class="text-5xl font-black profile-header-title">Profil Saya</h1>
                    <p class="text-slate-500 font-medium max-w-lg">Kelola identitas digital, verifikasi data, dan tingkatkan keamanan akun Anda dalam satu panel kendali.</p>
                </div>
                <div class="hidden lg:block pb-1">
                    <div class="flex -space-x-3 overflow-hidden">
                         <div class="inline-block h-12 w-12 rounded-2xl ring-4 ring-white bg-blue-600 flex items-center justify-center text-white shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-4 space-y-8">
                    <div class="glass-card-profile p-8 sticky top-10">
                        <h3 class="text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-6">Menu Pengaturan</h3>
                        <div class="space-y-2">
                            <a href="#info-umum" class="nav-item-profile active flex items-center gap-4 p-4 rounded-2xl text-sm transition-all group">
                                <div class="w-10 h-10 rounded-xl bg-blue-600/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                            ...
                            <a href="#keamanan" class="nav-item-profile flex items-center gap-4 p-4 rounded-2xl text-slate-500 text-sm transition-all group">
                            ...
                            <a href="#sesi-aktif" class="nav-item-profile flex items-center gap-4 p-4 rounded-2xl text-slate-500 text-sm transition-all group">
                                <div class="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center group-hover:scale-110 transition-transform">
                            ...
                            <a href="#akun-lain" class="nav-item-profile flex items-center gap-4 p-4 rounded-2xl text-slate-500 text-sm transition-all group">
                                <div class="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center group-hover:scale-110 transition-transform">
                            ...
                            <a href="#hapus-akun" class="nav-item-profile flex items-center gap-4 p-4 rounded-2xl text-red-500 text-sm transition-all group hover:bg-red-50">
                        ...
                        <div class="mt-10 pt-10 border-t border-slate-100/50">
                            <div class="p-5 rounded-[22px] bg-slate-900 text-white relative overflow-hidden group">
                                <div class="relative z-10">
                                    <div class="text-[9px] font-black text-blue-400 uppercase tracking-widest mb-2">Security Engine</div>
                                    <div class="text-sm font-bold flex items-center gap-3">
                                        <div class="flex space-x-1">
                                            <div class="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></div>
                                            <div class="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" style="animation-delay: 0.2s"></div>
                                            <div class="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" style="animation-delay: 0.4s"></div>
                                        </div>
                                        Sistem Terproteksi
                                    </div>
                                </div>
                                <i class="bi bi-shield-shaded absolute -right-4 -bottom-4 text-7xl text-white/5 group-hover:scale-125 transition-transform duration-700"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-8 space-y-10">
                    ...
                    <div id="sesi-aktif" class="glass-card-profile p-8 sm:p-12 scroll-mt-10 relative overflow-hidden">
                        ...
                        <i class="bi bi-display absolute -right-10 -top-10 text-[15rem] text-slate-400/5 -rotate-12"></i>
                    </div>
                    ...
                    {{-- Delete User --}}
                    <div id="hapus-akun" class="p-8 sm:p-12 bg-red-50/30 border border-red-100 rounded-[32px] shadow-2xl shadow-red-500/5 relative overflow-hidden group scroll-mt-10">
                        <div class="section-label text-red-600">Area Kritis</div>
                        <div class="max-w-2xl relative z-10">
                            <h4 class="text-red-600 font-black text-xl mb-3">Tutup Akun Permanen</h4>
                            <p class="text-red-700/70 text-sm mb-8 leading-relaxed">Menghapus akun akan menghilangkan semua data akses dan riwayat aktivitas Anda dari sistem ini selamanya.</p>
                            @include('profile.partials.delete-user-form')
                        </div>
                        <i class="bi bi-exclamation-triangle absolute -right-10 -bottom-10 text-[12rem] text-red-600/5 group-hover:rotate-12 transition-transform duration-700"></i>
                    </div>
    ...
    <script>
        ...
        document.querySelectorAll('#info-umum, #keamanan, #sesi-aktif, #akun-lain, #hapus-akun').forEach(section => {
